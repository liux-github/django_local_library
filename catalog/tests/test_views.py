...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(resp, 'form', 'due_back', '錯誤日付 - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(resp, 'form', 'due_back', '錯誤日付 - renewal more than 4 weeks ahead')
...
class AuthorCreateTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username='testuser2', password='12345')
        test_user2.save()
        permission = Permission.objects.get(name='作者編集権限')
        test_user2.user_permissions.add(permission)
        test_user2.save()
    ...
    def test_logged_in_with_permission_created_author(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.get(reverse('author_create'))
    ...
    def test_form_death_date_initially_has_date(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.get(reverse('author_create'))
        self.assertEqual( resp.status_code,200)
    ...
    def test_redirect_if_submit(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.post(reverse('author_create'), {'first_name':'John', 'last_name':'Smith', 'date_of_birth':'1972-01-01', 'date_of_death':'2018-01-05'})
